...
const data = [
  ...
  },
  {
    title: "쥐",
    description:
      "일어섰을때 쥐를 쳐다보면 기절에 걸립니다! 쥐의 저돌적인 돌진에 맞게되면 경직이 걸리므로 스페이스바(상태이상 무적)을 활용한 플레이를 펼쳐보세요!",
  },
  {
    title: "박쥐",
    description:
      "박쥐는 여러분들이 상태이상일때 공격받는다면 여러분의 피를 흡혈합니다!<br> 박쥐는 피가 별로 없으므로 근거리에서 검을 이용한 공격이 더 치명적일 수 있습니다!",
  }, // 쥐가 일어섰을 때 뒤돌아본다는 내용이 이해가 되지 않음    { title: '슬라임', description: '8초마다 당신의 공격력이 절반으로 감소하도록 만듭니다. 일정 거리 밖에서 활을 이용한 원거리 공격이 더 치명적일 수 있습니다!'}
  {
    title: "슬라임",
    description:
      "슬라임은 8초마다 플레이어의 공격력을 절반으로 감소시키는 디버프를 가지고 있습니다! 먼 거리에서 활로 쏘아 물리쳐 보세요!",
  },
  {
    title: "골렘-중간보스",
    description:
      "보스는 여러가지 기술을 사용 할 수 있습니다!<br> 가로,세로,대각선,중앙방향의 광역 폭발과 스페이스 바를 활용하여 돌진을 파악하고 피해보세요! <br>가끔 예상치 못한 박쥐떼에 조심하세요....",
  },
  {
    title: "최종보스",
    description:
      "평타: 전방 베기- 보스가 칼을 위로 드는 모션이 보이면 대쉬를 사용하거나 달려서 보스의 공격범위를 먼저 벗어나면 됩니다!<br>아래 찍기- 보스가 칼을 위로 들며 날이 바닥을 향하는 스킬에 맞게되면 기절에 걸립니다! 바닥에서 떨어저나온 폭발에 맞게된다면 피해만 입게됩니다!<br> 전방 6번 찌르기 후 뒤돌며 베기 - 전방 찌르기에 맞는 순간 플레이어가 경직효과에 걸리게 되어, 한 번 맞게되면 남은 찌르기를 모두 맞게됩니다! 칼을 뒤로 뺄때 범위에서 벗어나면 찌르기를 피할 수 있습니다!<br> (tip)뒤돌며 벨때 뒤쪽에서 칼로 맞받아 치면 보스가 무력화된다.<br> 보스가 웅크리고 빨간색으로 변했다면 공격하면 무시무시한 돌진이 플레이어에게 향할 것 입니다! 보스가 준비자세에 돌입할 때 공격을 멈추세요!",
  },
  {
    title: "처치-중간보스",
    description: "중간 보스 잡으면 칼 무기 바뀜 (칼/활 공격력 상승)",
  },
  {
    title: "대쉬",
    description: "스페이스바 누르면 마우스 커서 방향으로 대시",
  },
  {
    title: "칼-성능",
    description: "칼 공격력 활 1.5배",
  },
  {
    title: "화살",
